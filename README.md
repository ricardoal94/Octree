...
3. [Dataset ModelNet40](#dataset-modelnet40)
4. [Reproducibilidad: semillas y configuración](#reproducibilidad-semillas-y-configuración)
5. [Fase 1 — Configuración y partición](#fase-1--configuración-y-partición)
6. [Fase 2 — Construcción de octrees](#fase-2--construcción-de-octrees)
7. [Fase 3a — Enfoque clásico (HCE + SVM + Random Forest)](#fase-3a--enfoque-clásico-hce--svm--random-forest)
8. [Fase 3b — Enfoque profundo (Net5-Octree)](#fase-3b--enfoque-profundo-net5-octree)
9. [Fase 4 — Comparación y visualización](#fase-4--comparación-y-visualización)
10. [Experimento adicional — Img2Voxel](#experimento-adicional--img2voxel)
11. [Herramientas de análisis y figuras](#herramientas-de-análisis-y-figuras)
12. [Especificaciones técnicas exactas](#especificaciones-técnicas-exactas)
13. [Registros y resultados](#registros-y-resultados)
---
